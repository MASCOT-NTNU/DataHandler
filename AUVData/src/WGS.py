...
Example:
    >>> wgs = WGS()
    >>> x, y = wgs.latlon2xy(63.449019417045996, 10.39173914508783)
    >>> print(x, y)
    >>> 0.0, 0.0
    >>> x, y = 1000, 2000
    >>> lat, lon = wgs.xy2latlon(x, y)
    >>> print(lat, lon)
    >>> 63.458002573627404 10.4319454009669
"""
...
class WGS:
    ...
    __LATITUDE_ORIGIN = 63.449019417045996
    __LONGITUDE_ORIGIN = 10.39173914508783
